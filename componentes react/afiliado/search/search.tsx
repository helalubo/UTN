...
const Search = () => {
    ...
    return (
        <div className='search-container'>
            ...
            <InputText  name="apellido" label="Apellido"  content={afiliado.apellido} handlerInputChange={handlerInputChange}/>
            <InputText name="nombre" label="Nombre"  content={afiliado.nombre} handlerInputChange={handlerInputChange}/>
            <InputSelect name="tipoDoc" label="Tipo Doc:" options={options} content={afiliado.tipoDoc} handlerInputChange={handlerTipoDoc}  />
                {afiliado.tipoDoc !== "" && (
                     <InputText name="nroDoc" label="Número doc" content={afiliado.nroDoc} handlerInputChange={handlerInputChange}/>
                    )}
            </div>
